...
//Create Token and Token Contract with Permissions
contract StrategyDAO is ERC20, ERC20Burnable, ERC20Snapshot, AccessControl, Pausable, ERC20Permit, ERC20Votes, ERC20Detailed, Ownable, MinterRole {
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("StrategyDAO", "STDAO") ERC20Permit("StrategyDAO") {
        ...
        //Wallet Addresses (recommened to be multi-sig wallets)
        autoLiquidityReceiver = 0x2Abeef0110077330142F5613Af12464CC107C21b;
        TreasuryReceiver = 0x8ACC210BBb115abeF08911EbB7A1bC46BeFbAA38;
        RiskFreeValueReceiver = 0xbD0aF55E5903Aba7214D65d4fd1585656dc33a22;
    ...
    //end overrides required by solidity
    ...
    function mint(address recipient, uint256 amount) external MINTER_ROLE {
